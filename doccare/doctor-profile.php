...
if(isset($_POST['save1']))
{
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST") {
         ...
         $query=" UPDATE `doctor-registration` SET `doc_id`='$doc_id',`saluation`='$saluation',`spec_id`='$spec_id',`city`='$city',`state`='$state',`phone`='$phone' WHERE `doc_id`='$doc_id'";
...
if(isset($_POST['save2']))
{
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST") {
         ...
         $query2=" UPDATE `doctor-registration` SET `doc_id`='$doc_id',`regnumber`='$regnumber',`council`='$council',`year`='$year',`fees`='$fees',`experience`='$experience',`about`='$about',`docregpic`='$destfile' WHERE `doc_id`='$doc_id'";
         print_r( $query2);
...
$arrdata = mysqli_fetch_array($query4);
...
<h5 class="modal-title">Clinic Details</h5>
            ...
            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#staticBackdrop3" disabled>
                Enter Details
            </button>
                        ...
                        <div class="modal-body">
                            ...
                            <form method="post">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="phone" class="form-control" id="saluation">
                                </div>
                                <div class="mb-3">

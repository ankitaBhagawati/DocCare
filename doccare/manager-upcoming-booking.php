...
<body>
    ...
    margin-left: 80px;
">
        <h1 class="h3 mb-4 mt-5 text-gray-800">Upcoming Schedule </h1>
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    ...
                    where `manager-mapping`.`manager_id`='$manager_id' and `booking`.`doc_id`='$doc_id' and `booking`.`date` > date_format(curdate(), '%d/%m/%Y') ORDER BY `date`";

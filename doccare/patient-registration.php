...
if(isset($_POST['register']))
{
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $q =" select * from `useraccount` where email ='$Email' and `role`='patient'";
        // echo"$q"; 
      ...
      <button type='button' class='btn-close' data-bs-dismiss='alert' aria-label='Close'></button>
            ...
            $query ="INSERT INTO `useraccount` ( `firstname`, `lastname`,`email`, `password`,`token`,`registration_status`,`role`,`profilepic`)  VALUES ( '$FirstName', '$LastName' , '$Email','$hash','$Token','0','patient','images/patient/patient.png')";
     ...
     if($insquery>0){
        ...
        //$mail->SMTPDebug = 2; //to see all types of error in SMTP
            ...
            $mail->Subject = 'Email Activation';
             $mail->Body    = "Hi, $FirstName.Click here  http://localhost/doccare/patient-activate.php?token=$Token to activate your account";
        ...
        <div class="doc-reg-form col-lg-6 col-sm-12 ">
            ...
            <form method="post">
                <div class="form-border border rounded-3 p-3 border-muted col-lg-9 shadow">
                    ...
                    <input type="submit" class="btn m-1 btn-primary col-lg-12" name="register" value="Register">
            </form>
        </div>
    </div>

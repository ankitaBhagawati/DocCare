            ...
            <div class="card-header py-3">
                <div class="row">
                    ...
                    <div class="col" align="right">
                        <a href="manager-appointment-scheduling.php">
                        <button type="button"
                ...
                <div class="table-responsive">
                    <table class="table table-bordered" id="doctor_schedule_table" width="100%" cellspacing="0">
                        ...
                        //   $current_month=date('F Y');
                            include 'conne.php';
                            $q2=" SELECT  `doctor_availability`.*, `manager-mapping`.*
                        FROM `doctor_availability`
                    RIGHT JOIN `manager-mapping` ON `doctor_availability`.`doc_id` =  `manager-mapping`.`doc_id`
                    

                    where `manager_id`='$manager_id' ORDER BY `day_of_week` ";
